...
def _parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="0.0.0.0",
        help="Host address used by the Gradio demo."
    )
    parser.add_argument(
        "--server_port",
        type=int,
        default=7860,
        help="TCP port used by the Gradio demo."
    )
...
def run_graio_demo(args):
    ...
    demo.launch(server_name=args.server_host, debug=True, server_port=args.server_port)
